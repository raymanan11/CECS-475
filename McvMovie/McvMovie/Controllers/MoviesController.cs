...
namespace McvMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string movieGenre, string searchString) {
            ...
            var movieGenreVM = new AnMovieGenreViewModel {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Price,Rating")] AnMovie anMovie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Genre,Price,Rating")] AnMovie anMovie)
        {
            if (id != anMovie.Id)
            {
                return NotFound();
